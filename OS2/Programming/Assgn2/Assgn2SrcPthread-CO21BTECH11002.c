...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    for(int i=0; i<k; i++) {
        pthread_create(&threads[i], NULL, checkValid, &threadValues[i]);
    }
